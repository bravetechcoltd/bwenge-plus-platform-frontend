...
const ROLE_OPTIONS = [
  ...
  { value: "CONTENT_CREATOR", label: "Content Creator", icon: Users2, description: "Build and publish course content", color: "text-blue-600 bg-blue-50 border-blue-200" },
              ...
              {ROLE_OPTIONS.map(({ value, label, icon: Icon, description, color }) => (
                <div key={value} className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-xl border bg-gray-50">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    >
                      {generatingLink ? <Loader2 className="w-4 h-4 mr-1 animate-spin" /> : <LinkIcon className="w-4 h-4 mr-1" />}
