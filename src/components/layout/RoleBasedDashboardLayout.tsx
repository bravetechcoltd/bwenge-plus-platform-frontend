    ...
    INSTRUCTOR: [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            title: "Feedback",
            href: "/dashboard/instructor/students/feedback",
            icon: MessageSquare,
      ...
      subItems: [
        {
          ...
          href: "/dashboard/system-admin/financial/revenue",
          icon: TrendingUp
        },
        {
          title: "Payment Reports",
          href: "/dashboard/system-admin/financial/payments",
          icon: FileText
        },
        {
          title: "Billing Settings",
          href: "/dashboard/system-admin/financial/billing",
          icon: Settings
        },
        {
          title: "Invoice Management",
          href: "/dashboard/system-admin/financial/invoices",
          icon: CreditCard
        },
      ]
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          href: "/dashboard/system-admin/security/monitoring",
          icon: Server
        },
        {
          title: "Data Privacy",
          href: "/dashboard/system-admin/security/privacy",
          icon: Shield
        },
      ]
    },
...
export default function RoleBasedDashboardLayout({
  ...
  //         setPendingEnrollments(response.data.data.count)
  //       }
  //     } catch (error) {
  ...
  //   if (isAuthenticated && user?.bwenge_role === "SYSTEM_ADMIN") {
  ...
  // ==================== FIXED: Comprehensive user validation from all sources ====================
  useEffect(() => {
    if (!hydrated) return
