              ...
              <CardContent className="pb-2 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="p-2 bg-gray-50 rounded-lg text-center">
                    <div className="font-semibold">{format(new Date(assignment.submitted_at), "MMM d")}</div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-3 bg-gray-50 rounded-lg">
                  <div className="text-sm font-semibold">{format(new Date(selectedAssignment.submitted_at), "MMM d, yyyy")}</div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    {selectedAssignment.graded_at && (
                      <p className="text-xs text-gray-500 mt-2">
                        Graded on {format(new Date(selectedAssignment.graded_at), "MMM d, yyyy 'at' h:mm a")}
                      </p>
                    )}
                  </div>
                </div>
