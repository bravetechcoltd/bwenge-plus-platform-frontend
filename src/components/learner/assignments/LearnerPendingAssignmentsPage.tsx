            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-600">{stats.due_this_week}</p>
                </div>
          ...
          {selectedAssignment && (
            <div className="space-y-4 py-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-blue-800 mb-2">{selectedAssignment.title}</h4>
                <p className="text-sm text-blue-700 mb-2">{selectedAssignment.description}</p>
