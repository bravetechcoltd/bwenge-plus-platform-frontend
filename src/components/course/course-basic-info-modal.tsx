...
{/* Course Type and Level */}
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className={`text-xs font-medium ${formData.short_description.length > 180 ? 'text-amber-600' : 'text-muted-foreground'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2 p-4 border-2 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
              ...
              <Textarea
                ...
                rows={4}
                className="border-2 bg-white dark:bg-gray-950 resize-none"
              />
              <p className="text-xs text-blue-700 dark:text-blue-400 font-medium">One outcome per line</p>
            </div>
            ...
            <div className="space-y-2 p-4 border-2 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20">
              ...
              <Textarea
                ...
                className="border-2 bg-white dark:bg-gray-950 resize-none"
              />
              <p className="text-xs text-amber-700 dark:text-amber-400 font-medium">One requirement per line</p>
            </div>
          </div>
