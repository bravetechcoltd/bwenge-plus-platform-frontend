        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            >
              ...
              <Card className="p-4 text-center">
                <div className="text-2xl font-bold text-red-600">{(assessment.questions?.length || 0) - correctAnswers}</div>
            ...
            {isPreview && (
              <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.6 }}
                className="text-center p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800"
              >
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className={
                currentQuestionIndex === (assessment.questions?.length || 0) - 1 ? "bg-green-600 hover:bg-green-700" : ""
              }
            >
