...
import { BookOpen, ChevronDown, ChevronRight, Plus, Trash2, Trophy, Loader2, Save } from "lucide-react"
...
export function CourseTreeBuilder({ modules, setModules, onNext, onPrevious, type, loading, courseId, onSave }: CourseTreeBuilderProps) {
                ...
                {modules.length === 0 ? (
                  ...
                  modules.map((module) => (
                    <div key={module.id} className="space-y-1">
                      {/* Module Node */}
                      <div
                        className={`flex items-center gap-1 p-2 rounded-lg cursor-pointer transition-colors group ${selectedItem?.id === module.id
                      ...
                      >
                        ...
                        <div className="flex gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            disabled={module._status === 'deleting'}
                            className={`p-1 rounded ${module._status === 'deleting'
                        ...
                        <div className="ml-4 space-y-1 border-l border-gray-200 dark:border-gray-700 pl-2">
                          {module.lessons.map((lesson) => (
                            <div key={lesson.id} className="space-y-1">
                              <div
                                className={`flex items-center gap-1 p-2 rounded-lg cursor-pointer transition-colors group ${selectedItem?.id === lesson.id
                                    ? "bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-800"
                                    : "hover:bg-gray-50 dark:hover:bg-gray-800"
                              ...
                              >
                                ...
                                <div className="flex gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                                  <button
                                    ...
                                    disabled={lesson._status === 'deleting'}
                                    className={`p-1 rounded ${lesson._status === 'deleting'
                                        ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed'
                                        : 'hover:bg-green-100 dark:hover:bg-green-900 text-green-600'
                                      }`}
                              ...
                              {expandedLessons.has(lesson.id) && lesson.assessments && (
                                <div className="ml-4 space-y-1 border-l border-gray-200 dark:border-gray-700 pl-2">
                                  {lesson.assessments.map((assessment) => (
                                    <div
                                      key={assessment.id}
                                      className={`flex items-center gap-1 p-2 rounded-lg cursor-pointer transition-colors group ${selectedItem?.id === assessment.id
                                          ? "bg-primary-50 dark:bg-primary-950 border border-primary-200 dark:border-primary-800"
                                          : "hover:bg-gray-50 dark:hover:bg-gray-800"
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        className={`p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity ${assessment._status === 'deleting'
                                            ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed'
                                            : 'hover:bg-red-100 dark:hover:bg-red-900 text-red-600'
                                          }`}
                      ...
                      {expandedModules.has(module.id) && (
                        <div className="ml-4 space-y-1 border-l border-gray-200 dark:border-gray-700 pl-2">
                          {module.final_assessment ? (
                            <div
                              className={`flex items-center gap-1 p-2 rounded-lg cursor-pointer transition-colors group ${selectedItem?.id === module.final_assessment.id
                            ...
                            >
                              ...
                              <div className="flex gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button
                                  ...
                                  className={`p-1 rounded ${module.final_assessment._status === 'deleting'
                                      ? 'bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed'
                                      : 'hover:bg-red-100 dark:hover:bg-red-900 text-red-600'
                                    }`}
