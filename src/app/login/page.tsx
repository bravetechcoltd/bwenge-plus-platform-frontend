  ...
  return (
    <GoogleOAuthProviderWrapper>
      ...
      <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden relative bg-primary">
        ...
        {/* Width increased to 44% (20% wider than before), height reduced by 20% */}
        <div className="w-full lg:w-[44%] flex items-center justify-center p-4 sm:p-5 lg:p-6 relative z-20">
          {/* Back to Home pill button – top-left - more compact */}
          <Link
            href="/"
          ...
          <motion.div
            ...
            className="w-full max-w-[380px]" // Slightly smaller max-width for compactness
          >
            {/* ── Compact White Card ── */}
            <div className="bg-white/98 backdrop-blur-2xl rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.2)] border border-white/70 overflow-hidden">
              ...
              {/* Card Body - COMPACT with reduced spacing */}
              <div className="px-5 py-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    ...
                    <span className="text-xs text-gray-500 select-none">Remember</span>
                  </label>
                  <Link
                ...
                {/* Login Button - compact with solid bg-primary */}
                <motion.button
        ...
        <div className="hidden lg:flex w-full lg:w-[56%] relative overflow-hidden flex-col items-center justify-center bg-primary">
          ...
          {/* Background shapes - simplified with solid colors */}
