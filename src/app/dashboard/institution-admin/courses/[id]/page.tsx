        ...
        <div className="flex-1">
          <div className="flex items-center gap-4 mb-4">
            <Button
              variant="outline"
              size="sm"
              onClick={() => router.push(`/dashboard/institution-admin/${user?.primary_institution_id}/courses`)}
              className="mb-4"
            >
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Courses
          ...
          <h1 className="text-2xl font-bold mb-2 break-words min-w-0 max-w-full">{course.title}</h1>

          <div className="mb-4 overflow-hidden">
            <div className={!isDescriptionExpanded ? "line-clamp-3" : ""}>
              <RichContent html={course.description || ""} className="text-base" />
            </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button asChild>
                  <Link href={`/dashboard/system-admin/courses/${course.id}/modules`}>
                    ...
                    <AccordionTrigger className="text-left hover:no-underline">
                      <div className="flex items-center justify-between w-full mr-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-medium text-left break-words min-w-0 max-w-[300px] md:max-w-none">{module.title}</div>
                            <div className="text-sm text-muted-foreground text-left break-words min-w-0 line-clamp-1">{module.description}</div>
                          </div>
                        </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-3 flex-1">
                                ...
                                <div className="flex-1">
                                  <div className="font-medium text-sm break-words min-w-0">{lesson.title}</div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-3">
                  ...
                  {students.length === 0 ? (
                    ...
                    students.slice(0, 5).map((student, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center justify-between p-2.5 border rounded-lg gap-2 min-w-0">
                          <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() => router.push(`/dashboard/system-admin/courses/${course.id}/students`)}
                >
                  View All Students
                </Button>
              </div>
