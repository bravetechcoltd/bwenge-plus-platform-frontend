// frontend/app/dashboard/system-admin/enrollments/page.tsx
...
export default function SystemAdminEnrollmentsPage() {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      if (enrollmentsResponse.ok) {
        ...
        setStats(prev => ({ ...prev, pendingEnrollments: enrollmentsData.data?.length || 0 }))
      }
    } catch (error) {
    ...
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage access code requests and enrollment approvals across all public courses
          </p>
        </div>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Public SPOC Access Code Requests</p>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid grid-cols-2">
          ...
          <TabsTrigger value="pending-enrollments" className="relative">
            Pending Enrollments
            {stats.pendingEnrollments > 0 && (
              <Badge className="ml-2 bg-warning text-white">{stats.pendingEnrollments}</Badge>
            )}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="access-code-requests">
          <Card>
            <CardHeader>
              <CardTitle>Public SPOC Access Code Requests</CardTitle>
              <CardDescription>
                        ...
                        <TableRow key={request.id}>
                          ...
                          <TableCell>
                            {request.course.instructor ? (
                              ...
                              <span className="text-sm text-muted-foreground">No instructor</span>
                            )}
                          </TableCell>
                          <TableCell>
        ...
        <TabsContent value="pending-enrollments">
          <Card>
            <CardHeader>
              <CardTitle>All Pending Enrollments</CardTitle>
              <CardDescription>
                Enrollment requests waiting for approval across all courses
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loading ? (
                      ...
                      {filteredEnrollments.map((enrollment) => (
                        <TableRow key={enrollment.id}>
                          <TableCell>
                            <div className="flex items-center gap-3">
                              <Avatar className="w-8 h-8">
                                <AvatarImage src={enrollment.user.profile_picture_url || undefined} />
                                <AvatarFallback>
                          ...
                          <TableCell>
                            {getStatusBadge(enrollment.approval_status || "PENDING")}
                          </TableCell>
                          <TableCell className="text-right">
